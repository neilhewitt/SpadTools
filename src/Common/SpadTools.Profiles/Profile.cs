...
namespace SpadTools.Profiles
{
    public class Profile
    {
        ...
        public bool TryGetDevice(string id, out Device device)
        {
            device = GetDeviceOrDefault(id);
            return device is not null;
        }   

        private Device GetDeviceOrDefault(string id)
        {
